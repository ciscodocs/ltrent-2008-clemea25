...
8. As we introduce **FW** service in <font color="green">**VPN-1**</font>, so now click **Configuration > Configuration Groups > EMEA-London-Branch** configuration group and now we can see that it is now <font color="red">out of sync</font>.
