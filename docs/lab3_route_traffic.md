...
11. Click **Default Action**, click ![dots](./assets/S-1-figure-dots.png){ .off-glb width="25"}icon and click **Accept**. Click **<font color="orange">Save Match and Action</font>**. 
