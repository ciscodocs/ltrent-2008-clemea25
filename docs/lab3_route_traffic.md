...
6. On the **Service Chain Attachment Gateway** configuration page, provide ***Name*** and ***Description*** for the attachment gateway. For example, use the name and description **<font color="orange">Sydney-Branch-Service-Attachment-3</font>**.
...
20. Click **Activate** on **Activate Policy** pop-up.
    ![Configuring Data Policies](./assets/S-3-figure-44.png){ .off-glb }
21. Once policy is being pushed successfully, we can have **Push vSmart Policy** **Validation success** and **Message** “**<font color="green">Done – Push vSmart Policy**</font>”. 
...
!!! info
    ...
    and confirmed, delete the service chain parcel **Sydney-Branch-Service-Attachment-3** in **Sydney-Branch** WAN-Edge service profile **APAC-Sydney-Branch-Service-VPN**. Now we can confidently move forward to 
