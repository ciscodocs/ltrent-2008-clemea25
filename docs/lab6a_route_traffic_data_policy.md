...
19. Enter **VPN** **<font color="green">1</font>**, and under **TLOC List** select **Remote** and uncheck **Restrict**. Now enter the TLOC information of the **<font color="orange">Stockholm-Branch</font>** TLOC 
...
31. Under **Policies > Centralized Policy** page, click ![edit icon](./assets/S-1-figure-dots.png){ .off-glb width="25" } on the **Scenario-6** policy.
    1. Click **Activate**. 
...
```{ .ios, .no-copy title="Sydney Branch Centralized Policy"}
